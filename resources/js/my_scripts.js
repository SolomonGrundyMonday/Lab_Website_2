...
function loadStatsPage(){
    ...
    {
	homeValue = table.rows[counter].cells[2].innerHTML;
	awayValue = table.rows[counter].cells[3].innerHTML;
	homeValue = parseInt(homeValue);
	awayValue = parseInt(awayValue);
	if(homeValue > awayValue){
	    table.rows[counter].cells[4].innerHTML = "BUFFS";
	    wins++;
	}
	    ...
	    table.rows[counter].cells[4].innerHTML = "NONE";
	}
    }
...
function loadPlayersPage(){
	...
	var name = document.createTextNode(players[counter].name);
	

	a.appendChild(name);
	a.title = players[counter].name;
